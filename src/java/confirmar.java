...
public class confirmar extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       if (cliente != null) {
        ...
        if (resultado){response.sendRedirect("detalle.jsp?codigo=W0015&resp=10");}
        else{response.sendRedirect("comprar4.jsp?resp=2");}
        }else{response.sendRedirect("comprar4.jsp?msg=nulo");}
       }
       }else{
            if (cliente != null) {
