...
<body>
    <script language='javaScript' >
                            alert("¡Por favor acercarse a la tienda a reclamar su pedido!");
                        </script>
<div id="apDiv11">
...
<div class="center_prod_box_big">
        ...
        <p>
            <% if("J".equals(tipo)){%>
        <img src="img/FACTURA1.png" width="505" height="385">  <%}else{%><img src="img/BOLETA DE VENTA1.png" width="505" height="385">
      <%}%></p>
        <table width="207" border="0" align="center">
          <tr>
            <td><a href="javascript:window.print()"><img src="img/seguir.png" width="102" height="29" border="0"></a> </td>
            <td height="52"><div align="center"><a href="javascript:window.print()"><img src="img/imprimir.png" width="102" height="29" border="0"></a></div>
