<%-- 
    Document   : detalle_carrito
    Created on : 22/03/2011, 09:39:11 AM
...
<html xmlns="http://www.w3.org/1999/xhtml" content="1" url="detalle_carrito.jsp">
<head>
...
<link rel='index' title='Impulso Tecnol�gico' href='index.html' />
<!--[if IE]>
<style type="text/css">
...
<%
                    ...
                    try {
						...
						num=Integer.parseInt(rs.getString(1));
                                                precio=Integer.parseInt(rs.getString(2));
                                                total1=total1+num;
					     ...
					     %>
<div class="cart_details"> <%=total1%> items <br />
    <span class="border_cart"></span> Total: <span class="price">S/. <%=total2%></span> </div>
