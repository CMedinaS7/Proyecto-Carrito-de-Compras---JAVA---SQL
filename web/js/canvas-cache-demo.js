...
(function ($) {
   ...
   var cacheCanvasDemo = function () {
      ...
      var svgFiles = ['/js/canvg/svgs/building1.svg', '../js/canvg/svgs/building2.svg', '../js/canvg/svgs/building3.svg', '../js/canvg/svgs/building4.svg', '/js/canvg/svgs/cloud.svg'];
      for (i = 0; i < svgFiles.length; i++) {
            cachedItems[i] = cCache.newCanvas(570, 384);
      ...
      var loop = function () {
            ...
            ctx.fillRect(-700, -384, 1400, 384);
            ctx.fillStyle = '#888888'; //ctx.createPattern(img2,'repeat');  
            ctx.fillRect(-700, 0, 1400, 384);
