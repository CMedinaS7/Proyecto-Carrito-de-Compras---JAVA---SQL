  ...
  <table width="451" border="0">
    <%
            ...
            String ano=String.valueOf(f.get(java.util.Calendar.YEAR));
						...
						String a="exec mostrarcomprobante";
...
<div id="apDiv1"><span class="Estilo7"><%= Nombres + " " + Apellidos %></span></div>
...
<div class="center_content">
  ...
  <div class="prod_box_big">
    ...
    <div class="center_prod_box_big">
        ...
        <p><img src="img/BOLETA DE VENTA.png" width="505" height="385">        </p>
        <table width="207" border="0" align="center">
        <tr>
          <td height="52"><a href="confirmar1?cliente=<%=Codigo%>&confirmar=<%=Codigo%>&tipo=<%=tipo%>"><img src="img/confirmar.png" width="102" height="29" border="0"></a>
          <div align="center"></div></td><td width="190"><a href="confirmar?cliente=<%=Codigo%>&pagar=<%=Codigo%>&tipo=<%=tipo%>"><img src="img/pagar.png" width="102" height="29" border="0"></a></td>
          </tr>
      </table>
