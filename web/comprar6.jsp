  ...
  <table width="451" border="0">
    <%
            ...
            String ano=String.valueOf(f.get(java.util.Calendar.YEAR));
						...
						String a="exec mostrarboleta '" +Codigo+ "','"+ num +"'";
...
<div id="apDiv1"><span class="Estilo7"><% if("J".equals(tipo)){%>
    <%=rz%>
<%}else{%>
          <%=Nombres + " " + Apellidos%>
          <%}%></span></div>
...
<div class="center_prod_box_big">
        ...
        <p>
            <% if("J".equals(tipo)){%>
        <img src="img/FACTURA.png" width="505" height="385">  <%}else{%><img src="img/BOLETA DE VENTA.png" width="505" height="385">
      <%}%></p>
        <%
if (total > monto ){
%>
...
<script language='javaScript' >
                            alert("El monto de compra excede al de su tarjeta. Imposible realizar Operacion!");
                        </script>
        <table width="207" border="0" align="center">

    <tr>
            <td height="52"><div align="center"><a href="detalle.jsp?codigo=W0038"> <img src="img/regresar.png" width="102" height="29" border="0"> </a> </div>
            <p>&nbsp;</p>
    ...
    <tr>
            <td height="52"><div align="center">
              <div align="center"><a href="transact?cliente=<%=Codigo%>&monto=<%=total%>&tipo=<%=tipo%>&num=<%=num%>"> <img src="img/confirmar.png" width="102" height="29" border="0"> </a> </div>
            </div></td>
          </tr>
        </table>
            <%}%>
