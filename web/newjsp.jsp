<%-- 
    Document   : newjsp
    Created on : 15/02/2011, 04:47:26 PM
    Author     : Carlos Medina
--%>

<%@page contentType="text/html" pageEncoding="UTF-8" import="java.sql.*, java.util.*,java.lang.*,java.util.*, java.text.*,java.io.*,Dao.conexion" errorPage="" %>
...
//-------------- SE LLENA LA LISTA CON EL RESULTSET (rs) ---------------------------------------
//-------------- VARIABLE total_reg CONTIENE LA CANTIDAD TOTAL DE REGISTROS ---------------------
while (rs.next()){
lista_fol.add(new Integer (rs.getInt("numero")));
