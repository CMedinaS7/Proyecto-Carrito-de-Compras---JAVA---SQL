...
<div class="center_prod_box_big">
        ...
        <table width="207" border="0" align="center">
          <tr>
            <td height="52"><a href="confirmar?cliente=<%=Codigo%>&confirmar=<%=Codigo%>&tipo=<%=tipo%>"><img src="img/confirmar.png" width="102" height="29" border="0"></a>
            <div align="center"></div></td>
            <td width="190"><a href="confirmar?cliente=<%=Codigo%>&pagar=<%=Codigo%>&tipo=<%=tipo%>"><img src="img/pagar.png" width="102" height="29" border="0"></a></td>
          </tr>
        </table>
</div>
