    ...
    <body>
        ...
        <table width="567" border="1" bordercolor="#CCCCCC">
          <tr>
            ...
            <td width="47"><div align="center"><strong>Serie</strong></div></td>
            <td width="53"><div align="center"><strong>Cliente</strong></div></td>
            <td width="64"><div align="center"><strong>Fecha</strong></div></td>
            <td width="73"><div align="center"><strong>Total</strong></div></td>
            <td width="67"><div align="center"><strong>Eliminar</strong></div></td>
            <td width="92"><div align="center"><strong>Detalles</strong></div></td>
          </tr>
           <%
                    Connection cn;
                    ...
                    try {
						...
						String a="";
						if(filtro != null){
						a="exec listar_ventas_filtro '" + filtro+"'";
						}else{						
						a="exec listar_ventas";
						}            
          ...
          <tr>
            ...
            <td><div align="center" class="Estilo2"><a href="../eliminarcompra?c=<%=comprobante%>">eliminar</a></div></td>
            <td><div align="center" class="hastoc Estilo2"><a href="../detalles_pedido.jsp?c=<%=comprobante%>&cli=<%=cliente%>&s=s">ver</a></div></td>
          </tr>
          <%                                         
